...
class TestConfigurationSummary:
    ...
    def test_summary_with_interval(self, mock_print):
        ...
        main.display_configuration_summary(
            'MSFT', 'candlestick', 'TIME_SERIES_INTRADAY',
            '2024-01-01', '2024-01-31', '5min'
        )
...
class TestMainFlow:
    ...
    @patch('builtins.print')
    def test_complete_flow_without_interval(self, mock_print, mock_date_range,
                                           mock_time_series, mock_chart, mock_symbol,
                                           mock_env):
    ...
    @patch('builtins.print')
    def test_complete_flow_with_interval(self, mock_print, mock_date_range,
                                        mock_interval, mock_time_series,
                                        mock_chart, mock_symbol, mock_env):
    ...
    @patch('sys.exit')
    @patch('builtins.print')
    def test_keyboard_interrupt_handling(self, mock_print, mock_exit,
                                        mock_symbol, mock_env):
    ...
    @patch('sys.exit')
    @patch('builtins.print')
    def test_unexpected_error_handling(self, mock_print, mock_exit,
                                      mock_symbol, mock_env):
